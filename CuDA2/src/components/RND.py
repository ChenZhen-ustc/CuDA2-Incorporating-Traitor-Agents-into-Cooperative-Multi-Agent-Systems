...
class RND:
    ...
    def save_model(self,path):
        torch.save(self.model.state_dict(), "{}/model.pth".format(path))
        torch.save(self.target.state_dict(), "{}/target.pth".format(path))

    def load_model(self,path):
        self.model.load_state_dict(torch.load("{}/model.pth".format(path)))
        self.target.load_state_dict(torch.load("{}/target.pth".format(path)))
